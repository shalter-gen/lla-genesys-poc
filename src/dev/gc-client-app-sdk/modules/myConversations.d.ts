 ...
 * @since 1.3.0
 */
declare class MyConversationsApi extends BaseApi {
    /**
     ...
     * @since 1.3.0
     */
    showInteractionDetails(conversationId: string): void;
    /**
     ...
     * @since 1.3.0
     */
    showEvaluationDetails(conversationId: string, evaluationId: string): void;
}
