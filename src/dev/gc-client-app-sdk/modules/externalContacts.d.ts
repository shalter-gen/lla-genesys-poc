 ...
 * @since 1.4.0
 */
declare class ExternalContactsApi extends BaseApi {
    /**
     ...
     * @since 1.4.0
     */
    showExternalContactProfile(externalContactId: string): void;
    /**
     ...
     * @since 1.4.0
     */
    showExternalOrganizationProfile(externalOrganizationId: string): void;
}
