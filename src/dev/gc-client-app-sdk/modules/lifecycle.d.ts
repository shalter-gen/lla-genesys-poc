...
export declare type LifecycleHook = 'bootstrap' | 'focus' | 'blur' | 'stop';
/**
 * Utilities for monitoring and updating the lifecycle of a Genesys Cloud Client App
 *
 * ### Lifecycle Hooks
 ...
 * @since 1.0.0
 */
declare class LifecycleApi extends BaseApi {
    /**
     ...
     * @since 1.0.0
     */
    addBootstrapListener(listener: (event: SDKMessagePayload) => void, once?: boolean): void;
    /**
     ...
     * @since 1.0.0
     */
    removeBootstrapListener(listener: (event: SDKMessagePayload) => void, once?: boolean): void;
    /**
     ...
     * @since 1.0.0
     */
    addFocusListener(listener: (event: SDKMessagePayload) => void, once?: boolean): void;
    /**
     ...
     * @since 1.0.0
     */
    removeFocusListener(listener: (event: SDKMessagePayload) => void, once?: boolean): void;
    /**
     ...
     * @since 1.0.0
     */
    addBlurListener(listener: (event: SDKMessagePayload) => void, once?: boolean): void;
    /**
     ...
     * @since 1.0.0
     */
    removeBlurListener(listener: (event: SDKMessagePayload) => void, once?: boolean): void;
    /**
     ...
     * @since 1.0.0
     */
    addStopListener(listener: (event: SDKMessagePayload) => void, once?: boolean): void;
    /**
     ...
     * @since 1.0.0
     */
    removeStopListener(listener: (event: SDKMessagePayload) => void, once?: boolean): void;
}
