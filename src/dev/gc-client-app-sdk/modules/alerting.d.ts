...
declare const VALID_MESSAGE_TYPES: readonly ["error", "info", "success"];
declare type ValidMessageType = typeof VALID_MESSAGE_TYPES[number];
declare type ToastOptions<Type extends ValidMessageType, Timeout extends number> = {
    /**
...
declare type ToastTimeoutConfig<Type extends ValidMessageType, Timeout extends number> = Type extends 'error' ? {
    /**
...
declare type ToastCloseButtonConfig<Timeout extends number> = Timeout extends 0 ? {
    /**
 ...
 * @since 1.0.0
 */
declare class AlertingApi extends BaseApi {
    /**
     ...
     * @since 1.0.0
     */
    showToastPopup<MessageType extends ValidMessageType, Timeout extends number>(title: string, message: string, options?: ToastOptions<MessageType, Timeout>): void;
    /**
