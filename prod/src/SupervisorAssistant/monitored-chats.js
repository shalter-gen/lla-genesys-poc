...
function filterTable(e) {
    ...
    rows.forEach(row => {
        ...
        const userCell = row.cells[5].textContent; // User is in 5th column
        ...
        if (prodOnly) {
            ...
            showRow = showRow && (queueCell.includes('LLA_SMS PROD') || queueCell.includes('LLA_WebChat PROD'));
            showRow = showRow && userCell;
        }
